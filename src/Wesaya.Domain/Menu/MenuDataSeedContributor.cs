    ...
    : IDataSeedContributor, ITransientDependency
{
    ...
    protected virtual async Task SeedCategoriesAsync()
    {
    ...
    protected virtual async Task SeedItemsAsync()
    {
        ...
        int displayOrder)
    {
        ...
        await categoryRepository.InsertAsync(
            MenuCategory.Create(
                ...
                Strong(englishName, arabicName, MenuConsts.MaxCategoryNameLength),
                displayOrder),
            autoSave: true);
    ...
    protected virtual async Task CreateItemIfNotExistsAsync(
