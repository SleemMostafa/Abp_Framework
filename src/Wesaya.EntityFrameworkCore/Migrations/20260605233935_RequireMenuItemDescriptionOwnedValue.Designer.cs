...
namespace Wesaya.Migrations
{
    ...
    [Migration("20260605233935_RequireMenuItemDescriptionOwnedValue")]
    partial class RequireMenuItemDescriptionOwnedValue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wesaya.Menu.MenuCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wesaya.Menu.MenuItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wesaya.Menu.MenuCategory", b =>
                {
                    b.OwnsOne("Wesaya.Localization.StrongLocalizedString", "Name", b1 =>
                        {
                            b1.Property<Guid>("MenuCategoryId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("MenuCategoryId");

                            b1.HasIndex("Arabic");

                            b1.HasIndex("English");

                            b1.ToTable("AppMenuCategories");
            ...
            modelBuilder.Entity("Wesaya.Menu.MenuItem", b =>
                {
                    b.HasOne("Wesaya.Menu.MenuCategory", null)
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.OwnsOne("Wesaya.Localization.OptionalLocalizedString", "Description", b1 =>
                        {
                            ...
                            b1.ToTable("AppMenuItems");

                            b1.WithOwner()
                                .HasForeignKey("MenuItemId");
                        });

                    b.OwnsMany("Wesaya.Menu.ExtraItem", "ExtraItems", b1 =>
                        {
                            b1.Property<Guid>("MenuItemId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.ToTable("AppMenuItemExtraItems", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("MenuItemId");

                            b1.OwnsOne("Wesaya.Localization.StrongLocalizedString", "Name", b2 =>
                                {
                                    b2.Property<Guid>("ExtraItemMenuItemId")
                                        .HasColumnType("uniqueidentifier");

                                    b2.Property<int>("ExtraItemId")
                                        .HasColumnType("int");
                                    ...
                                    b2.HasKey("ExtraItemMenuItemId", "ExtraItemId");

                                    b2.ToTable("AppMenuItemExtraItems");

                                    b2.WithOwner()
                                        .HasForeignKey("ExtraItemMenuItemId", "ExtraItemId");
                                });
