...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 2e650439-62a6-4651-827a-8736fd7610df
```

> `2e650439-62a6-4651-827a-8736fd7610df` is the password of the certificate, you can change it to any password you want.
